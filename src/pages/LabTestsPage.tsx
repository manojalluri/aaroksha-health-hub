          ...
          <>
            <div className="relative px-4 pb-3">
              ...
              <input
                ...
                className="w-full h-11 rounded-2xl bg-slate-50 border border-slate-200 pl-10 pr-4 text-sm text-slate-700 placeholder:text-slate-400 outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-100 transition-all"
              />
            </div>
