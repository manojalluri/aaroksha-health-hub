      ...
      <div className="relative z-10 w-full max-w-md px-6 py-10 mx-auto">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="relative mb-6">
            <div
              className="h-20 w-20 rounded-3xl flex items-center justify-center shadow-2xl border border-purple-400/20"
              style={{ background: "linear-gradient(135deg, #7c3aed, #5b21b6)" }}
            >
              <FlaskConical className="h-10 w-10 text-white" />
            </div>
            <span className="absolute -top-1 -right-1 h-5 w-5 bg-violet-400 rounded-full border-2 border-slate-900 animate-pulse" />
          </div>
